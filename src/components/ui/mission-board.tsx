...
export function MissionBoard({
    ...
    switch (selectedTab) {
      case "available":
        return safeMissions.filter(
          (mission) => !mission.isAccepted && !mission.isCompleted
        );
      case "active":
        return safeMissions.filter(
          (mission) => mission.isAccepted && !mission.isCompleted
      ...
      case "completed":
        return safeMissions.filter(
          (mission) => mission.isCompleted || completedMissions.has(mission.id)
        );
      case "all":
      default:
        return safeMissions;
  ...
  const MissionCard = ({ mission }: { mission: Mission }) => {
    ...
    const isCompleted =
      mission.isCompleted || completedMissions.has(mission.id);
          ...
          <div className="flex items-start justify-between">
            ...
            <div className="flex flex-col items-end gap-1">
              ...
              <Badge variant="outline" className="text-xs">
                {MISSION_CATEGORIES[
                  mission.category as keyof typeof MISSION_CATEGORIES

...
export function BookListDetail({ id }: BookListDetailProps) {
    ...
    const handleShare = async () => {
        try {
            ...
            toast({
                title: "Erreur",
                description: "Impossible de partager cette liste"
            });
        }
    };
    ...
    const handleRemoveBook = async (bookId: string) => {
        try {
            ...
            toast({
                title: "Succès",
                description: "Livre retiré de la liste"
            });
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex flex-wrap gap-3 text-sm text-muted-foreground">
                            ...
                            <div className="flex items-center gap-1">
                                ...
                                <span>{bookList.bookCount} {bookList.bookCount > 1 ? 'livres' : 'livre'}</span>
                            </div>
                            <Badge variant="outline">
                                {bookList.genre.charAt(0).toUpperCase() + bookList.genre.slice(1)}
                            </Badge>
                        </div>
                    </div>

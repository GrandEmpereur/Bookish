...
class UserService {
    ...
    async getAuthenticatedProfile(): Promise<GetAuthenticatedProfileResponse> {
        try {
            return await apiRequest<GetAuthenticatedProfileResponse>('GET', '/users/me');
        } catch (error: any) {
    ...
    async getRelations(): Promise<GetUserRelationsResponse> {
        return await apiRequest<GetUserRelationsResponse>('GET', '/users/relations');
    }

    // PATCH /users/profile
    async updateProfile(data: Partial<UpdateProfileRequest>): Promise<UpdateProfileResponse> {
        return await apiRequest<UpdateProfileResponse>('PATCH', '/users/profile', { data });
    }
    ...
    async updateProfilePicture(file: File): Promise<UpdateProfilePictureResponse> {
        ...
        return await apiRequest<UpdateProfilePictureResponse>('POST', '/users/avatar', {
            data: formData
        });
    }
    ...
    async checkFriendshipStatus(userId: string): Promise<CheckFriendshipStatusResponse> {
        return await apiRequest<CheckFriendshipStatusResponse>('GET', `/users/${userId}/friendship`);
    }

...
class GamificationService {
  ...
  async getDashboard(): Promise<GamificationDashboardResponse> {
    return this.makeRequest<GamificationDashboardResponse>(
      "GET",
  ...
  async changeGameMode(data: { modeId: string }): Promise<GameModeResponse> {
    return this.makeRequest<GameModeResponse>(
      "POST",
  ...
  async submitSessionReading(data: {
    sessionDuration: number;
  }): Promise<BasicGamificationResponse> {
    const eventData: EventData = {
      eventType: "session_reading",
      sessionDuration: data.sessionDuration,
    };
    return this.makeRequest<BasicGamificationResponse>(
      "POST",
      "/gamification/events",
      { data: eventData }
    );
  ...
  async submitBookCompleted(data: {
    bookId: string;
    rating?: number;
  }): Promise<BasicGamificationResponse> {
    const eventData: EventData = {
  ...
  async acceptMission(data: {
    missionId: string;
  }): Promise<BasicGamificationResponse> {
    return this.makeRequest<BasicGamificationResponse>(
      "POST",
      "/gamification/missions/accept",
      { data }
    );
  }
  ...
  async completeMission(data: {
    ...
    return this.makeRequest<BasicGamificationResponse>(
      "POST",
      "/gamification/missions/complete",
      { data }
    );
  }
  ...
  async getBadges(
    category?: "reading" | "social" | "achievement"
  ): Promise<BadgesResponse> {
    const params = category ? { category } : {};
    return this.makeRequest<BadgesResponse>("GET", "/gamification/badges", {
      params,
    });
  }
  ...
  async getLeaderboards(
    ...
    return this.makeRequest<LeaderboardResponse>(
      "GET",
  ...
  async getEventsOverview(): Promise<EventsOverviewResponse> {
    return this.makeRequest<EventsOverviewResponse>(
      "GET",
      "/gamification/events/"
    );
  }
  ...
  async getHappyHours(): Promise<HappyHoursResponse> {
    return this.makeRequest<HappyHoursResponse>(
      "GET",
      "/gamification/events/happy-hours"
    );
  }

  // POST /gamification/events/happy-hours (Admin)
  async createHappyHour(
    data: CreateHappyHourRequest
  ): Promise<BasicGamificationResponse> {
    return this.makeRequest<BasicGamificationResponse>(
      "POST",
      "/gamification/events/happy-hours",
  ...
  async getFlashContests(): Promise<FlashContestsResponse> {
    return this.makeRequest<FlashContestsResponse>(
      "GET",
      "/gamification/events/flash-contests"
    );
  }

  // POST /gamification/events/flash-contests (Create Flash Contest)
  async createFlashContest(
    data: CreateFlashContestRequest
  ): Promise<BasicGamificationResponse> {
    return this.makeRequest<BasicGamificationResponse>(
      "POST",
      "/gamification/events/flash-contests",
  ...
  async getSpecialEvents(): Promise<SpecialEventsResponse> {
    return this.makeRequest<SpecialEventsResponse>(
      "GET",
      "/gamification/events/special-events"
    );
  }

  // GET /gamification/events/multipliers
  async getMultipliers(): Promise<MultipliersResponse> {
    return this.makeRequest<MultipliersResponse>(
      "GET",
      "/gamification/events/multipliers"
    );
  }
  ...
  async joinHappyHour(happyHourId: string): Promise<BasicGamificationResponse> {
    return this.makeRequest<BasicGamificationResponse>(
      "POST",
      `/gamification/events/happy-hours/${happyHourId}/join`
    );
  }

  async joinFlashContest(
    contestId: string
  ): Promise<BasicGamificationResponse> {
    return this.makeRequest<BasicGamificationResponse>(
      "POST",
      `/gamification/events/flash-contests/${contestId}/join`
    );
  }

  async participateInSpecialEvent(
    eventId: string
  ): Promise<BasicGamificationResponse> {
    return this.makeRequest<BasicGamificationResponse>(
      "POST",
      `/gamification/events/special-events/${eventId}/participate`
    );
  }
  ...
  async getEquippedItems(): Promise<EquippedItemsResponse> {
    return this.makeRequest<EquippedItemsResponse>(
      "GET",
      "/gamification/inventory/equipped"
    );
  }

  // GET /gamification/inventory/stats
  async getInventoryStats(): Promise<InventoryStatsResponse> {
    return this.makeRequest<InventoryStatsResponse>(
      "GET",
      "/gamification/inventory/stats"
    );
  }

  // GET /gamification/inventory/shop
  async getInventoryShop(): Promise<InventoryShopResponse> {
    return this.makeRequest<InventoryShopResponse>(
      "GET",
      "/gamification/inventory/shop"
    );
  }
  ...
  async purchaseInventoryItem(
    ...
    return this.makeRequest<BasicGamificationResponse>(
      "POST",
      "/gamification/inventory/shop/purchase",
      { data }
    );
  }
  ...
  async openMysteryBox(
    boxType: string,
    cost: number
  ): Promise<MysteryBoxOpenResponse> {
    return this.makeRequest<MysteryBoxOpenResponse>(
      "POST",
      "/gamification/inventory/mystery-box/open",
      {
        data: { boxType, cost },
      }
    );
  ...
  async equipItem(itemId: string): Promise<BasicGamificationResponse> {
    return this.makeRequest<BasicGamificationResponse>(
      "POST",
      `/gamification/inventory/items/${itemId}/equip`
    );
  }
  ...
  async unequipItem(itemId: string): Promise<BasicGamificationResponse> {
    return this.makeRequest<BasicGamificationResponse>(
      "POST",
      `/gamification/inventory/items/${itemId}/unequip`
    );
  }
  ...
  async getChallenges(
    ...
    return this.makeRequest<ChallengesResponse>(
      "GET",
  ...
  async acceptChallenge(
    ...
    return this.makeRequest<BasicGamificationResponse>(
      "POST",
      `/gamification/challenges/${challengeId}/accept`
    );
  }
  ...
  async declineChallenge(
    ...
    return this.makeRequest<BasicGamificationResponse>(
      "POST",
      `/gamification/challenges/${challengeId}/decline`
    );
  }
  ...
  async updateChallengeProgress(
    ...
    return this.makeRequest<BasicGamificationResponse>(
      "POST",
      `/gamification/challenges/${challengeId}/update-progress`,
      { data }
    );
  }
  ...
  async getPopularChallenges(): Promise<PopularChallengesResponse> {
    return this.makeRequest<PopularChallengesResponse>(
      "GET",
      "/gamification/challenges/public/popular"
    );
  }

  // GET /gamification/challenges/stats/personal
  async getPersonalChallengeStats(): Promise<PersonalChallengeStatsResponse> {
    return this.makeRequest<PersonalChallengeStatsResponse>(
      "GET",
      "/gamification/challenges/stats/personal"
    );
  }

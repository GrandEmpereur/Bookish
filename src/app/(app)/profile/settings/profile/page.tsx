...
const AVAILABLE_GENRES = [
    ...
    "History", "Self-help", "Business", "Health", "Travel", "Cooking", "Art", "Poetry"
];
...
const EditProfilePage: React.FC = () => {
    ...
    const loadUserProfile = async () => {
        try {
            ...
            setProfileData({
                ...
                birth_date: formatBirthDate(profileData?.birthDate || profileData?.birth_date || ""),
                bio: profileData?.bio || "",
                ...
                preferred_genres: profileData?.preferredGenres || profileData?.preferred_genres || [],
                profile_visibility: profileData?.profileVisibility || profileData?.profile_visibility,
                allow_follow_requests: profileData?.allowFollowRequests ?? profileData?.allow_follow_requests ?? true,
                email_notifications: profileData?.emailNotifications ?? profileData?.email_notifications ?? true,
                push_notifications: profileData?.pushNotifications ?? profileData?.push_notifications ?? true,
                newsletter_subscribed: profileData?.newsletterSubscribed ?? profileData?.newsletter_subscribed ?? false,
            });
        } catch (error) {
    ...
    const handleSave = async () => {
        try {
            ...
            const formattedData = {
                ...profileData,
                birth_date: profileData.birth_date ? profileData.birth_date.replace(/\//g, '-') : ""
            };
                    ...
                    <CardContent className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <Select 
                                ...
                                onValueChange={(value: ReadingHabit) => handleInputChange("reading_habit", value)}
                            >
                                <SelectTrigger>
                                    <SelectValue placeholder="Sélectionnez votre habitude de lecture" />
                                </SelectTrigger>
                                <SelectContent>
                                    <SelectItem value="library_rat">Rat de bibliothèque</SelectItem>
                                    <SelectItem value="occasional_reader">Lecteur occasionnel</SelectItem>
                                    <SelectItem value="beginner_reader">Lecteur débutant</SelectItem>
                                </SelectContent>
                            </Select>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <Select 
                                ...
                                onValueChange={(value: UsagePurpose) => handleInputChange("usage_purpose", value)}
                            >
                                <SelectTrigger>
                                ...
                                <SelectContent>
                                    ...
                                    <SelectItem value="find_community">Trouver une communauté</SelectItem>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                                {AVAILABLE_GENRES.map((genre) => (
                                    <div key={genre} className="flex items-center space-x-2">
                                        <Checkbox
                                            id={genre}
                                            checked={(profileData.preferred_genres || []).includes(genre)}
                    ...
                    <CardContent className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <Select 
                                ...
                                onValueChange={(value: ProfileVisibility) => handleInputChange("profile_visibility", value)}
                            >
                                <SelectTrigger>
                        ...
                        <div className="flex items-center justify-between">
                            <div className="space-y-0.5">
                                ...
                                <p className="text-sm text-gray-500">Les autres utilisateurs peuvent vous demander de les suivre</p>
                            </div>
                            <Switch 
                                checked={profileData.allow_follow_requests}
                                onCheckedChange={(checked) => handleInputChange("allow_follow_requests", checked)}
                            />
                        </div>
                    </CardContent>
                </Card>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="space-y-0.5">
                                ...
                                <p className="text-sm text-gray-500">S'abonner à notre newsletter</p>
                            </div>
                            <Switch 

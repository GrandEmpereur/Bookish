      ...
      <div className="flex-1 px-5 pt-25 pb-[120px]">
        <div className="flex flex-col items-center justify-center py-12 space-y-4">
          ...
          <p className="text-center text-muted-foreground">
            Seuls les modérateurs et administrateurs du club peuvent accéder à
            cette page.
          </p>
          <Button
            variant="outline"
            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <p className="text-muted-foreground">
                  Les clubs publics n'ont pas de demandes d'adhésion. Les
                  utilisateurs peuvent rejoindre directement.
                </p>
              </CardContent>
            </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      <Avatar className="w-12 h-12">
                        <AvatarImage
                          src={
                            request.user?.profile?.profile_picture_url ||
                            undefined
                          }
                        />
                        <AvatarFallback>
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  ...
                                  {request.user?.username} dans le club.
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                          ...
                          <AlertDialog>
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  Vous êtes sur le point de rejeter la demande
            ...
            <div className="space-y-4">
              ...
              <Card>
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-muted-foreground">
                    Interface de gestion des signalements en cours de
                    développement.
                  </p>
                </CardContent>
              </Card>
                      ...
                      <div className="flex gap-2">
                        <Button
                          ...
                          onClick={() => {
                            ...
                            toast.info(
                              "Fonction de bannissement à implémenter"
                            );
                          }}
                        >

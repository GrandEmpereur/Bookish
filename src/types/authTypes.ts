import type { UserProfile, UserRole, UsagePurpose, ReadingHabit } from './userTypes';
...
export interface AuthService {
    ...
    requestPasswordReset(data: ForgotPasswordRequest): Promise<RequestPasswordResetResponse>;
    verifyResetCode(data: VerifyResetCodeRequest): Promise<VerifyResetCodeResponse>;
    resetPassword(data: ResetPasswordRequest): Promise<ResetPasswordResponse>;
    logout(): Promise<LogoutResponse>;
    completeStepOne(data: RegisterStepOneRequest): Promise<RegisterStepOneResponse>;
    completeStepTwo(data: RegisterStepTwoRequest): Promise<RegisterStepTwoResponse>;
    completeStepThree(data: RegisterStepThreeRequest): Promise<RegisterStepThreeResponse>;
}

...
export interface ClubService {
    ...
    updateClub(id: string, data: UpdateClubRequest): Promise<ApiResponse<UpdateClubResponse>>;
    deleteClub(id: string): Promise<ApiResponse<null>>;
    joinClub(id: string, data: JoinClubRequest): Promise<ApiResponse<JoinClubResponse>>;
    leaveClub(id: string): Promise<ApiResponse<null>>;
    getMessages(clubId: string): Promise<ApiResponse<GetClubMessagesResponse>>;
    sendMessage(clubId: string, data: SendMessageRequest): Promise<ApiResponse<SendMessageResponse>>;
    generateInviteLink(clubId: string): Promise<ApiResponse<GenerateInviteLinkResponse>>;

...
export const createBookListSchema = z.object({
    ...
    coverImage: z.array(z.custom<File>((file) => file instanceof File, "Le fichier n'est pas valide")
...
export const updateBookListSchema = z.object({
    ...
    coverImage: z.instanceof(File)
        .refine(file => file.size <= MAX_FILE_SIZE, "L'image ne doit pas dépasser 10MB")
        .refine(
